   ...
   --     elseif enh == 'AssaultEngineering' then
    ...
    CreateEnhancement = function(self, enh, removal)
        ...
        elseif enh == 'ApocalypticEngineering' then
            ...
            gun:AddDamageMod(bp.FlameDamageMod)
            gun:ChangeMaxRadius(bp.FlameMaxRadius)
			gun:ChangeRateOfFire(bp.FlameRateOfFire)
			gun:ChangeDamageRadius(bp.FlameDamageRadius)
			gun:SetFiringRandomness(bp.FlameRandomness)
			local gun2 = self:GetWeaponByLabel('RightZephyr')
			gun2:ChangeProjectileBlueprint('/mods/BlackOpsFAF-ACUs-YYPatch/projectiles/LaserBotTerranFrag/LaserBotTerranFrag_proj.bp')
		...
		elseif enh == 'BuffEngineering' then
            ...
            if not Buffs['UEFSpeedAura'] then
                BuffBlueprint {
                    Name = 'UEFSpeedAura',
                    DisplayName = 'UEFSpeedAura',
		...
		elseif enh == 'SupportEngineering' then
            ...
            if not Buffs['UEFSpeedAura2'] then
                BuffBlueprint {
                    Name = 'UEFSpeedAura2',
                    DisplayName = 'UEFSpeedAura2',
                    BuffType = 'COMMANDERAURA_RegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
		...
		elseif enh == 'AuxillaryEngineering' then
            ...
            if not Buffs['UEFSpeedAura3'] then
                BuffBlueprint {
                    Name = 'UEFSpeedAura3',
                    DisplayName = 'UEFSpeedAura3',
                    BuffType = 'COMMANDERAURA_RegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
		...
		elseif enh == 'AssistingEngineering' then
            ...
            if not Buffs['UEFSpeedAura4'] then
                BuffBlueprint {
                    Name = 'UEFSpeedAura4',
                    DisplayName = 'UEFSpeedAura4',
                    BuffType = 'COMMANDERAURA_RegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
        ...
        elseif enh == 'TacticalNukeSubstitutionRemove' then
            ...
            local wep = self:GetWeaponByLabel('ClusterMissiles')
            wep:AddDamageMod(bp.ClusterDamageMod)
        elseif enh == 'ExpandedThoriumBlock' then
            if not Buffs['UEFMissileHealth4'] then
                BuffBlueprint {
                    Name = 'UEFMissileHealth4',
                    DisplayName = 'UEFMissileHealth4',
                    BuffType = 'UEFMissileHealth',
                    Stacks = 'STACKS',
                    Duration = -1,
                    Affects = {
            ...
            Buff.ApplyBuff(self, 'UEFMissileHealth4')
    ...
    ShieldEffects2 = {
        '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/uef_shieldgen_01_emit.bp',
    },

    FlamerEffects = {
        '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/flamer_torch_01.bp',
    },
}
