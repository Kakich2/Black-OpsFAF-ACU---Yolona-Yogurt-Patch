...
local BlackOpsEffectTemplate = import('/mods/BlackOpsFAF-ACUs-YYPatch/lua/ACUsEffectTemplates.lua')
...
EEA0002 = Class(TAirUnit) {
    ...
    OpenState = State() {
        Main = function(self)
            ...
            self.OpenAnim:PlayAnim('/mods/BlackOpsFAF-ACUs-YYPatch/units/EEA0002/eea0002_aopen01.sca')
            self.Trash:Add(self.OpenAnim)
            WaitFor(self.OpenAnim)
            
            self.OpenAnim:PlayAnim('/mods/BlackOpsFAF-ACUs-YYPatch/units/EEA0002/eea0002_aopen02.sca')
        ...
        ProjSpawn = function(self)
            if not self:IsDead() then
                ...
                proj = self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/projectiles/SpysatSMDBait/SpysatSMDBait_proj.bp', loc[1], loc[2], loc[3], nil, nil, nil):SetCollision(false)
                Warp(proj, loc)
