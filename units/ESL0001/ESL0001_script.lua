...
ESL0001 = Class(ACUUnit) {
    ...
    Weapons = {
		...
		YolonaYathu = Class(SeraACUMissile) {},
        OverCharge = Class(SDFChronotronOverChargeCannonWeapon) {},
        AutoOverCharge = Class(SDFChronotronOverChargeCannonWeapon) {},
		TeslaBeam1 = Class(SDFUnstablePhasonBeam) {},
		TeslaBeam2 = Class(SDFUnstablePhasonBeam) {},
		TeslaBeam3 = Class(SDFUnstablePhasonBeam) {},
    },
    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		self:SetWeaponEnabledByLabel('YolonaYathu', false)
		self:SetWeaponEnabledByLabel('TeslaBeam1', false)
		self:SetWeaponEnabledByLabel('TeslaBeam2', false)
		self:SetWeaponEnabledByLabel('TeslaBeam3', false)
    ...
    RegenBuffThread = function(self, enh)
		...
		elseif enh == 'ApocalypticEngineering' then
			buff = 'SeraphimACUAdvancedRegenAura2'
		elseif enh == 'ExterminatorEngineering' then
			buff = 'SeraphimACUAdvancedRegenAura3'
        end
    ...
    CreateEnhancement = function(self, enh, removal)
        ...
        elseif enh == 'ApocalypticEngineering' then
            self:RemoveBuildRestriction(categories.SERAPHIM * (categories.BUILTBYTIER4COMMANDER))
            self:updateBuildRestrictions()
            if not Buffs['SeraphimACUAdvancedRegenAura2'] then
                BuffBlueprint {
                    Name = 'SeraphimACUAdvancedRegenAura2',
                    DisplayName = 'SeraphimACUAdvancedRegenAura2',
                    BuffType = 'COMMANDERAURA_AdvancedRegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
        ...
        elseif enh == 'ExterminatorEngineering' then
            self:RemoveBuildRestriction(categories.SERAPHIM * (categories.BUILTBYTIER4COMMANDER))
            self:updateBuildRestrictions()
            if not Buffs['SeraphimACUAdvancedRegenAura3'] then
                BuffBlueprint {
                    Name = 'SeraphimACUAdvancedRegenAura3',
                    DisplayName = 'SeraphimACUAdvancedRegenAura3',
                    BuffType = 'COMMANDERAURA_AdvancedRegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
            ...
            if not Buffs['SERAPHIMACUT5BuildCombat'] then
                BuffBlueprint {
                    Name = 'SERAPHIMACUT5BuildCombat',
                    DisplayName = 'SERAPHIMACUT5BuildCombat',
                    BuffType = 'ACUBUILDRATE',
                    Stacks = 'STACKS',
                    Duration = -1,
                    Affects = {
            ...
            -- Affect the ACU        
            Buff.ApplyBuff(self, 'SERAPHIMACUT5BuildCombat')
        elseif enh == 'ExterminatorEngineeringEngineeringRemove' then
            if Buff.HasBuff(self, 'SERAPHIMACUT5BuildCombat') then
                Buff.RemoveBuff(self, 'SERAPHIMACUT5BuildCombat')
            end
        ...
        -- Tesla Beam
        elseif enh == 'EnhancedReactor' then
            if not Buffs['SeraphimTBHealth1'] then
                BuffBlueprint {
                    Name = 'SeraphimTBHealth1',
                    DisplayName = 'SeraphimTBHealth1',
            ...
            Buff.ApplyBuff(self, 'SeraphimTBHealth1')

        elseif enh == 'EnhancedReactorRemove' then
            if Buff.HasBuff(self, 'SeraphimTBHealth1') then
                Buff.RemoveBuff(self, 'SeraphimTBHealth1')
            end
         elseif enh == 'TeslaBeam' then
            if not Buffs['SeraphimTBHealth2'] then
                BuffBlueprint {
                    Name = 'SeraphimTBHealth2',
                    DisplayName = 'SeraphimTBHealth2',
                    BuffType = 'SeraphimTorpHealth',
                    Stacks = 'STACKS',
                    Duration = -1,
                    Affects = {
            ...
            Buff.ApplyBuff(self, 'SeraphimTBHealth2')
            
            self:SetWeaponEnabledByLabel('TeslaBeam1', true)
        elseif enh == 'TeslaBeamRemove' then
            if Buff.HasBuff(self, 'SeraphimTBHealth2') then
                Buff.RemoveBuff(self, 'SeraphimTBHealth2')
            end
        self:SetWeaponEnabledByLabel('TeslaBeam1', false)          	
         elseif enh == 'QuantumEnergyTransmitter' then
            if not Buffs['SeraphimTBHealth3'] then
                BuffBlueprint {
                    Name = 'SeraphimTBHealth3',
                    DisplayName = 'SeraphimTBHealth3',
                    BuffType = 'SeraphimTorpHealth',
                    Stacks = 'STACKS',
                    Duration = -1,
                    Affects = {
            ...
            Buff.ApplyBuff(self, 'SeraphimTBHealth3')
            
            self:SetWeaponEnabledByLabel('TeslaBeam2', true)
			self:SetWeaponEnabledByLabel('TeslaBeam1', false)
        elseif enh == 'QuantumEnergyTransmitterRemove' then
            if Buff.HasBuff(self, 'SeraphimTBHealth3') then
                Buff.RemoveBuff(self, 'SeraphimTBHealth3')
            end
        self:SetWeaponEnabledByLabel('TeslaBeam2', false)    	
         elseif enh == 'WarpSingularity' then
            if not Buffs['SeraphimTBHealth4'] then
                BuffBlueprint {
                    Name = 'SeraphimTBHealth4',
                    DisplayName = 'SeraphimTBHealth4',
                    BuffType = 'SeraphimTorpHealth',
                    Stacks = 'STACKS',
                    Duration = -1,
                    Affects = {
            ...
            Buff.ApplyBuff(self, 'SeraphimTBHealth4')
            
            self:SetWeaponEnabledByLabel('TeslaBeam3', true)
			self:SetWeaponEnabledByLabel('TeslaBeam2', false)
        elseif enh == 'WarpSingularityRemove' then
            if Buff.HasBuff(self, 'SeraphimTBHealth4') then
                Buff.RemoveBuff(self, 'SeraphimTBHealth4')
            end
        self:SetWeaponEnabledByLabel('TeslaBeam3', false) 		
