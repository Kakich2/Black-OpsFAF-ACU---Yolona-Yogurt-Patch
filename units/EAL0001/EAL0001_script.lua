...
EAL0001 = Class(ACUUnit) {
    ...
    CreateEnhancement = function(self, enh, removal)
		...
		elseif enh == 'BuffEngineering' then
            ...
            if not Buffs['AeonDamageAura'] then
                BuffBlueprint {
                    Name = 'AeonDamageAura',
                    DisplayName = 'AeonDamageAura',
		...
		elseif enh == 'SupportEngineering' then
            ...
            if not Buffs['AeonDamageAura2'] then
                BuffBlueprint {
                    Name = 'AeonDamageAura2',
                    DisplayName = 'AeonDamageAura2',
                    BuffType = 'COMMANDERAURA_RegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
		...
		elseif enh == 'AuxillaryEngineering' then
            ...
            if not Buffs['AeonDamageAura3'] then
                BuffBlueprint {
                    Name = 'AeonDamageAura3',
                    DisplayName = 'AeonDamageAura3',
                    BuffType = 'COMMANDERAURA_RegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
		...
		elseif enh == 'AssistingEngineering' then
            ...
            if not Buffs['AeonDamageAura4'] then
                BuffBlueprint {
                    Name = 'AeonDamageAura4',
                    DisplayName = 'AeonDamageAura4',
                    BuffType = 'COMMANDERAURA_RegenAura',
                    Stacks = 'STACKS',
                    Duration = 5,
                    Affects = {
        ...
        elseif enh == 'MaelstromQuantum' then
            ...
            table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Torso', self:GetArmy(), '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/maelstrom_aura_01_emit.bp'):ScaleEmitter(1):OffsetEmitter(0, -2, 0))
            table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Torso', self:GetArmy(), '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/maelstrom_aura_02_emit.bp'):ScaleEmitter(1):OffsetEmitter(0, -2.75, 0))
