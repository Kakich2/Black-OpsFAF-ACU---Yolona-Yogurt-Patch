...
local ACUsEffectTemplate = import('/mods/BlackOpsFAF-ACUs-YYPatch/lua/ACUsEffectTemplates.lua')
...
FlameThrowerProjectile01 = Class(EmitterProjectile) {
    FxTrails = {'/mods/BlackOpsFAF-ACUs-YYPatch/Effects/Emitters/NapalmTrailFX.bp',},
    FxTrailScale = 0.75,
