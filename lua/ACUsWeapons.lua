...
local CollisionBeamFile = import('/mods/BlackOpsFAF-ACUs-YYPatch/lua/ACUsDefaultCollisionBeams.lua')
...
UEFACUAntiMatterWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = import('/mods/BlackOpsFAF-ACUs-YYPatch/lua/ACUsEffectTemplates.lua').ACUAntiMatterMuzzle,
}
...
EMPWeapon = Class(CCannonMolecularWeapon) {
    OnWeaponFired = function(self)
        ...
        if self.targetaquired then
            ...
            table.insert(self.unit.EMPArrayEffects01, AttachBeamEntityToEntity(self.unit, 'EMP_Array_Beam_01', self.unit, 'EMP_Array_Muzzle_01', self.unit:GetArmy(), '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/cemparraybeam02_emit.bp'))
            table.insert(self.unit.EMPArrayEffects01, AttachBeamEntityToEntity(self.unit, 'EMP_Array_Beam_02', self.unit, 'EMP_Array_Muzzle_02', self.unit:GetArmy(), '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/cemparraybeam02_emit.bp'))
            table.insert(self.unit.EMPArrayEffects01, AttachBeamEntityToEntity(self.unit, 'EMP_Array_Beam_03', self.unit, 'EMP_Array_Muzzle_03', self.unit:GetArmy(), '/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/cemparraybeam02_emit.bp'))
...
UEFACUHeavyPlasmaGatlingCannonWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = import('/mods/BlackOpsFAF-ACUs-YYPatch/lua/ACUsEffectTemplates.lua').UEFACUHeavyPlasmaGatlingCannonMuzzleFlash,
