...
CEMPArrayBeam01CollisionBeam = Class(HawkCollisionBeam) {
    FxBeam = {'/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/cemparraybeam01_emit.bp'},
    FxBeamEndPoint = {},
    FxBeamStartPoint = {},
    FxBeamStartPointScale = 0.05,
    FxBeamEndPointScale = 0.05,
...
CEMPArrayBeam02CollisionBeam = Class(HawkCollisionBeam) {
    FxBeam = {'/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/cemparraybeam02_emit.bp'},
...
AeonACUPhasonLaserCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/BlackOpsFAF-ACUs-YYPatch/effects/emitters/phason_beam_01_emit.bp'},
