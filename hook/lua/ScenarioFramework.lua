function FakeGateInUnit(unit, callbackFunction)
    ...
    if EntityCategoryContains(categories.COMMAND, unit) then
        ...
        if faction == 1 then
            unit:SetMesh('/mods/BlackOpsFAF-ACUs-YYPatch/units/eel0001/EEL0001_PhaseShield_mesh', true)
        ...
        elseif faction == 2 then
            unit:SetMesh('/mods/BlackOpsFAF-ACUs-YYPatch/units/eal0001/EAL0001_PhaseShield_mesh', true)
            unit:ShowBone(0, true)
        ...
        elseif faction == 3 then
            unit:SetMesh('/mods/BlackOpsFAF-ACUs-YYPatch/units/erl0001/ERL0001_PhaseShield_mesh', true)
            unit:ShowBone(0, true)
        ...
        elseif faction == 4 then
            unit:SetMesh('/mods/BlackOpsFAF-ACUs-YYPatch/units/xsl0001/ESL0001_PhaseShield_mesh', true)
            unit:HideBone('Engineering', true)
            unit:HideBone('Combat_Engineering', true)
