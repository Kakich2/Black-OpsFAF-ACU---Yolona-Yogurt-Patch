-----------------------------------------------------------------------------------------------------------------------------
-- File     :  /mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01EffectController01/Cluster01EffectController01_script.lua
...
Cluster01EffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01Effect01/Cluster01Effect01_proj.bp', 0, FireballDomeYOffset, 0, 0, 0, 1)

        -- Create projectile that controls plume effects
        local PlumeEffectYOffset = 0.0625
        self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01Effect02/Cluster01Effect02_proj.bp', 0, PlumeEffectYOffset, 0, 0, 0, 1)
    ...
    CreateInitialFireballSmokeRing = function(self)
        ...
        for i = 0, sides - 1 do
            ...
            self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01Shockwave01/Cluster01Shockwave01_proj.bp', X * OffsetMod, 0.09375, Z * OffsetMod, X, 0, Z)
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, sides - 1 do
            local X = math.sin(i * angle)
            local Z = math.cos(i * angle)
            local proj =  self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01Shockwave02/Cluster01Shockwave02_proj.bp', X * OffsetMod, 0.15625, Z * OffsetMod, X, 0, Z)
    ...
    CreateFlavorPlumes = function(self)
        ...
        for i = 0, numProjectiles - 1 do
            ...
            table.insert(projectiles, self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01FlavorPlume01/Cluster01FlavorPlume01_proj.bp', 0, 0, 0, xVec, yVec, zVec):SetVelocity(velocity))
        end
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, sides - 1 do
            ...
            local proj = self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01Effect03/Cluster01Effect03_proj.bp', x, HeightOffset, z, x, 0, z)
                :SetVelocity(velocity)
            table.insert(projectiles, proj)
        end
    ...
    CreateGroundPlumeConvectionEffects = function(self, army)
        ...
        for i = 0, sides - 1 do
            ...
            self:CreateProjectile('/mods/BlackOpsFAF-ACUs-YYPatch/effects/Entities/Cluster01Effect05/Cluster01Effect05_proj.bp', x, RandomFloat(outer_lower_height, outer_upper_height), z, x, 0, z)
