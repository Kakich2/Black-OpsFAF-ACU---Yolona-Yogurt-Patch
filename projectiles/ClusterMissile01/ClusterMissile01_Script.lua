...
local TMissileCruiseProjectile = import('/mods/BlackOpsFAF-ACUs-YYPatch/lua/ACUsProjectiles.lua').UEFACUClusterMIssileProjectile
...
ClusterMissle01 = Class(TMissileCruiseProjectile) {
    ...
    SetTurnRateByDist = function(self)
        ...
        elseif dist > 0 and dist <= 8 then
            ...
            local ChildProjectileBP = '/mods/BlackOpsFAF-ACUs-YYPatch/projectiles/SmallYieldNuclearBomb01/SmallYieldNuclearBomb01_proj.bp'  
